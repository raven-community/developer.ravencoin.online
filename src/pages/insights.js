...
const Insights = ({ location, data }: Props) => {
  ...
  return (
    <DefaultLayout location={location}>
      <HelmetPlus
        title={`Inisghts - developer.ravencoin.online`}
        description={
          'Insights into the learnings and process people have faced while building new products with Ravencoin and Rvnbox'
        }
        keywords={
          'inisghts, blog, rvnbox, tutorials, developer tools, ravencoin, rvncoin, RVN, sdk, api'
        }
        location={location}
      />
      <Hero image={HeroImg}>
