...
const Tutorials = ({ location, data }: Props) => {
  ...
  return (
    <DefaultLayout location={location}>
      <HelmetPlus
        title={`Tutorials - developer.ravencoin.online`}
        description={
          'Tutorials for the building on Ravencoin, utilizing the Rvnbox'
        }
        keywords={
          'rvnbox, tutorials, developer tools, ravencoin, Ravencoin, RVN, sdk, api'
        }
        location={location}
      />
      <Hero image={HeroImg}>
        <HeroLayout>
          ...
          <H3 background>
            Real world examples to learn from and bootstrap your next Ravencoin
            project
          </H3>
        </HeroLayout>
      </Hero>
