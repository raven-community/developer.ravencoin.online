...
const About = ({ location }: Props) => (
  <DefaultLayout location={location}>
    <HelmetPlus
      title={`About  - developer.ravencoin.online`}
      description={
        'ravencoin.online developer platform.  Developer Tooling, Resources, Cloud, and Marker'
      }
      keywords={
        'about, rvnbox, tutorials, developer tools, ravencoin, rvncoin, RVN, sdk, api'
      }
      location={location}
    />
    <Hero image={HeroImg}>
      <HeroLayout>
        <H3 primary>ravencoin.online's developer platform</H3>
    ...
    <Container>
      <AboutLayout>
        <Item>
          <H3>RVNBOX</H3>
          <Text>
            ravencoin.online’s developer platform is based on the popular RVNBOX
        ...
        <Item>
          <H3>REST</H3>
          <Text>
            The RVN JSON RPC over HTTP including a fully documented and
        ...
        <Item>
          ...
          <Text>
            ...
            metrics, testing and more all built w/ RVNBOX.
          </Text>
        </Item>
        <Item>
          <H3>Market</H3>
